# ugly WIP code, copy-paste from 
# https://raw.githubusercontent.com/OpenSenseAction/OPENSENSE_sandbox/main/notebooks/opensense_data_downloader_and_transformer.py
